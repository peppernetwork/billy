  ...
  $.ajax({
   ...
   success:function(data)
   {
    ...
    if(data.length > 0)
    {
     ...
     {
      html += '<tr>';
      html += '<td> <center><form method="get"><input class="ButtonSelect" type="submit" name="auswahl" formaction="rechnung_erstellen.php?var=value" value="'+data[count].id+'"></form></center> </td>';
