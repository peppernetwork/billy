...
<div class="column3">
  <?php
    ...
    echo "<input type='text' disabled name='angebotid' placeholder='Angebotsnummer (wird automatisch vergeben)' value='Angebot Nr. $angebotjahr-$angebotid' />";
