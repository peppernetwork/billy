...
include '../../inc/connect.php';
  ...
  $pos30 = $_POST["pos"][29];
	...
	$insertString = "INSERT INTO angebote (angebotjahr, kunde, anrede, datum, referenz, zahlungsbedingungen, geserab, gesprab, netto, mwst, brutto, 
	...
	VALUES ('$angebotjahr', '$kunde', '$anrede', '$datum', '$referenz', '$zahlungsbedingungen', '$geserab', '$gesprab', '$netto', '$mwst', '$brutto', 
			'$pos1', '$pos1anz', '$pos1einheit', '$pos1dsc', '$pos1ep', '$pos1erab', '$pos1prab', 
			'$pos2', '$pos2anz', '$pos2einheit', '$pos2dsc', '$pos2ep', '$pos2erab', '$pos2prab', 
			'$pos3', '$pos3anz', '$pos3einheit', '$pos3dsc', '$pos3ep', '$pos3erab', '$pos3prab', 
			'$pos4', '$pos4anz', '$pos4einheit', '$pos4dsc', '$pos4ep', '$pos4erab', '$pos4prab', 
...
<?php
// Hier wird der Kunde ausgegeben, welcher zuvor ausgewaehlt wurde.
  ...
  // Kundenauswahl Verarbeitung
	...
	echo "<input name='id' type='hidden' value='$id'>"; ?>
  	<input type="hidden" name="angebotjahr" value="<?php echo date('Y'); ?>" />
